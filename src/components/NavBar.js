    ...
    <NavBarContainer>
        <ButtonContainer>
          ...
          <ImportButtonLabel htmlFor="file">
            <ImportButtonIcon src={ImportButton} alt="import a timline button" />
          </ImportButtonLabel> 
          <ExportButtonContainer src={ExportButton} onClick={exportTimeLine} alt="export a timline button" />
